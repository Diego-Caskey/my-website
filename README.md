...
## Noted Issues:
- Mobile breakpoints are not addressed on multiple pages (Header squished, font size inconsistencies)
- Page spacing and layout unoptimized (Footer congested, simulated viewports inefficient)
